...
namespace GameBox.Graphics
{
    internal struct Vbo
    {
        ...
        public int strideVertex;
        internal Vbo LoadVBO<TVertex>(TVertex[] vertices, short[] elements) where TVertex : struct
        {
            Vbo handle = new Vbo();
            int size;
            ...
            strideVertex = BlittableValueType.StrideOf(vertices);
            GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(vertices.Length * strideVertex), vertices, BufferUsageHint.StaticDraw);
        ...
        void Draw()
        {
            ...
            GL.VertexPointer(3, VertexPointerType.Float, strideVertex, new IntPtr(0));
            GL.ColorPointer(4, ColorPointerType.UnsignedByte, strideVertex, new IntPtr(12));
